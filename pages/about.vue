      ...
      <div class="container">
        <div class="abt-page-row">
          <div class="row align-items-center">
            ...
            <div class="col-12">
              <img src="/images/aboutUs.svg" width="1000" height="667" class="w-100" alt="About US">
            </div>
            <div class="col-lg-12">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6">
              <div class="act-inffo">
                ...
                <h2>Our Mission</h2>
                <p>
                  Praesent rhoncus justo erat, sed sollicitudin arcu malesuada vel. Etiam scelerisque
                  justo ut purus luctus ullamcorper. Vivamus vitae elit ligula. Fusce eu rutrum
                  nisl.
                </p>
                <ul>
          ...
          <div class="col-lg-6">
            <div class="section-title">
              ...
              <p>
                Praesent rhoncus justo erat, sed sollicitudin arcu malesuada vel. Etiam scelerisque
                justo
                ut purus luctus ullamcorper. Vivamus vitae elit ligula. Fusce eu rutrum nisl. Vestibulum
                ut sagittis neque
              </p>
